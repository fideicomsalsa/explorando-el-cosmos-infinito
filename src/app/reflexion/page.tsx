    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 pt-24 pb-20">
        <div className="absolute inset-0">
          <div
            className="absolute inset-0 cosmic-gradient opacity-30 animate-pulse"
        ...
        <div className="container mx-auto max-w-5xl z-10">
          ...
          >
                ...
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div className="space-y-4 text-white/90 leading-relaxed text-lg">
                    <p className="first-letter:text-5xl first-letter:font-bold first-letter:text-primary first-letter:mr-1 first-letter:float-left">
                      En la vastedad infinita del cosmos, donde miles de millones
                      de galaxias danzan en el lienzo oscuro del espacio-tiempo,
                      existimos. Pequeños, frágiles, efímeros. Y sin embargo,
                      conscientes.
                    </p>
                    <p>
                      Somos polvo de estrellas que se ha despertado para
                      contemplar el universo del cual surgimos. Cada átomo de
                      nuestro cuerpo fue forjado en el corazón ardiente de
                      estrellas ancestrales que murieron hace eones, explotando
                      en supernovas y esparciendo sus elementos por el cosmos.
                    </p>
                    <p>
                      Hemos mirado hacia arriba durante milenios, primero con
                      asombro primitivo, luego con telescopios cada vez más
                      poderosos. Hemos descubierto que no somos el centro, que
                      nuestra Tierra es apenas un punto azul pálido suspendido
                      en un rayo de sol cósmico.
                    </p>
                    <p className="text-xl font-light italic text-primary">
                      Y en ese descubrimiento de nuestra pequeñez, encontramos
              ...
              <div className="bg-gradient-to-br from-primary/20 to-secondary/20 backdrop-blur-xl border border-white/30 rounded-2xl p-8 md:p-12">
                <div className="text-center mb-8">
                  ...
                  <p className="text-white/80">
                    ¿Qué significa para ti la inmensidad del cosmos? Comparte
                    tus pensamientos...
                  </p>
                </div>
            ...
            >
              <div className="space-y-4">
                ...
                <blockquote className="text-2xl md:text-3xl font-light text-white/90 italic">
                  "El cosmos es todo lo que es, todo lo que fue y todo lo que
                  será. Nuestras contemplaciones del cosmos nos conmueven...
                  Hay un cosquilleo en la columna vertebral, un nudo en la
                  garganta, una sensación débil como de un recuerdo lejano, de
                  caer desde una altura. Sabemos que nos estamos aproximando al
            ...
            <motion.div
              ...
              className="text-center space-y-6 pb-10"
            >
              ...
              <blockquote className="text-2xl md:text-3xl font-light text-white/90 italic max-w-3xl mx-auto">
                "En medio de esta vastedad que no termina, coincidimos por un
                instante improbable. Nos elegimos, nos perdimos, nos rompimos un
                poco... y aun así, algo de lo que fuimos sigue viajando entre
                las luces antiguas del universo."
              </blockquote>
              <p className="text-white/60 text-base">— un poeta anónimo</p>
            </motion.div>
          </motion.div>
        </div>
      </section>
